-- Fix the ambiguous column reference in the has_classroom_access function
...
-- Fix the ambiguous column reference in the has_student_analytics_access function
